...
router.post("/blockuser/:id",auth.requireToken,commonFunctions.verifyAdmin,adminController.blockUser);
router.post("/unblockuser/:id",auth.requireToken,commonFunctions.verifyAdmin,adminController.unblockUser);
